...
const dict = {
  ...
  // Modèle de bulletin
  bulletinTemplateTitle: { fr: 'Modèle de bulletin', en: 'Report card template' },
  bulletinTemplateExplain: {
    fr: "Téléversez le bulletin officiel de votre école au format Word (.docx). Insérez les balises suivantes aux bons endroits :",
    en: 'Upload your school\'s official report card as a Word file (.docx). Insert these tags in the right places:',
  },
  bulletinTagsSingle: {
    fr: 'Balises simples : {studentName} {admissionNo} {className} {schoolName} {session} {term} {overallAverage}',
    en: 'Single tags: {studentName} {admissionNo} {className} {schoolName} {session} {term} {overallAverage}',
  },
  bulletinTagsLoop: {
    fr: 'Ligne de tableau répétée (une ligne par matière) : {#subjects}{subjectName} {ca} {exam} {average}{/subjects}',
    en: 'Repeating table row (one per subject): {#subjects}{subjectName} {ca} {exam} {average}{/subjects}',
  },
  currentTemplate: { fr: 'Modèle actuel :', en: 'Current template:' },
  noBulletinTemplate: { fr: 'Aucun modèle téléversé.', en: 'No template uploaded.' },
  uploadTemplate: { fr: 'Téléverser un modèle (.docx)', en: 'Upload a template (.docx)' },
  templateUploaded: { fr: 'Modèle enregistré.', en: 'Template saved.' },
  templateUploadError: {
    fr: "Échec de l'envoi. Vérifiez que le fichier est un .docx valide.",
    en: 'Upload failed. Check that the file is a valid .docx.',
  },
  downloadMyBulletin: { fr: 'Télécharger mon bulletin', en: 'Download my report card' },
  bulletinNotAvailable: {
    fr: "Votre école n'a pas encore configuré de modèle de bulletin.",
    en: "Your school hasn't set up a report card template yet.",
  },
  ...
  // Bulletin (print/PDF)
  bulletinPageTitle: { fr: 'Bulletin de notes', en: 'Report card' },
  printOrSavePdf: { fr: 'Imprimer / Enregistrer en PDF', en: 'Print / Save as PDF' },
  studentInfo: { fr: 'Élève', en: 'Student' },
  overallAverageLabel: { fr: 'Moyenne générale', en: 'Overall average' },
  generatedOn: { fr: 'Généré le', en: 'Generated on' },
  officialDocumentNote: {
    fr: 'Document généré électroniquement par',
    en: 'Electronically generated by',
  },
} as const;
